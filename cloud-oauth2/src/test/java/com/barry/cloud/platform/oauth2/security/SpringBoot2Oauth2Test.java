...
public class SpringBoot2Oauth2Test {
    ...
    public void getUserInfo() throws Exception {
        ...
        log.info("用户信息返回的结果={}", JSONMapper.writeObjectAsString(result));
    }
    ...
    public void signInTest() throws Exception {
        ...
        log.info("登录信息返回的结果={}", JSONMapper.writeObjectAsString(result));
    }
    ...
    private String getAccessToken() {
        ...
        log.info("accessToken={}", JSONMapper.writeObjectAsString(t));
