package com.barry.cloud.platform.simpleimage.utils;
...
/**
 * @description:simpleimage 图片处理工具类 功能 等比例缩放 裁切 加水印 复合操作
 * @author: Tongshan.Han
 * @time: 2019/8/9 14:24
 */
public class ImageUtils {
    ...
    public static void main(String[] args) {
        ...
        // 400);
        // 4.缩放到指定高度
        //scaleWithHeight("D:\\img\\src.jpg", "D:\\img\\scaleWithHeight.jpg", 600);
        // 5.裁切成正方形
